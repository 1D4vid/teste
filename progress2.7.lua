return function(env)
    ...
    -- =========================================================================
    -- SISTEMA DE COMPUTADORES (Escopo do Módulo - Instantâneo)
    -- =========================================================================
    local function createComputerProgressBar(parent)
    ...
    local function setupComputer(tableModel)
        ...
        local billboard, bar, text = createComputerProgressBar(tableModel)
    ...
    local function rebuildComputers()
    ...
    -- =========================================================================
    -- SISTEMA DE PORTAS (Escopo do Módulo - Instantâneo)
    -- =========================================================================
    local DT_CONFIG = { 
    ...
    local function createDoorHighlight(model)
    ...
    local function setupNormalDoor(doorModel)
        ...
        local highlight = createDoorHighlight(doorModel)
    ...
    Library:CreateDropdown(Page, "PC Progress Design", {"Default", "Style 1", "Style 2"}, "Default", function(val)
        task.defer(function()
            ...
            rebuildComputers() -- Reconfigura e reconstrói instantaneamente
        end)
    end)
    ...
    Library:CreateDropdown(Page, "Door Progress Design", {"Default", "Style 1", "Style 2"}, "Default", function(val)
        task.defer(function()
            ...
            rebuildDoors() -- Reconfigura e reconstrói instantaneamente
        end)
    end)
