return function(env)
    ...
    local function ApplyBaseAppearanceAndModifiers()
        ...
        local ok, err = pcall(function()
            ...
            -- Otimização: FindFirstChild evita chamadas de espera desnecessárias
